...
public class EditTeman extends AppCompatActivity {
    ...
    private static String url_select = "https://20200140082.praktikumtiumy.com/updatetm.php";
        ...
        StringRequest stringReq = new StringRequest(Request.Method.POST, url_select, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (sukses == 1) {
                        Toast.makeText(EditTeman.this, "Sukses mengedit mengedit data", Toast.LENGTH_SHORT).show();
